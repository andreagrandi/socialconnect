...
public slots:
    ...
    bool retrieveHomeTimeline(const QString &from, const QString &to, int max);
    bool sendDirectMessage(const QString &to, const QString &message);
...
signals:
    ...
    // Twitter specific API
    void sendDirectMessageCompleted(bool success);
